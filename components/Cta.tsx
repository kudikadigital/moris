          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
                ...
                <span className="text-orange-500">liderar</span> o futuro?
              </h2>
              <p className="text-slate-400 text-lg mb-10 max-w-md">
                Não ensinamos apenas matérias, formamos protagonistas. Pequenos
                grandes líderes, grandes transformações.
              </p>
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  <p className="text-slate-400 text-sm mb-1 uppercase tracking-widest font-bold">
                    Localização
                  </p>
                  <p className="text-white text-lg">Benfica, Via Expressa</p>
                  <p className="text-slate-400 text-sm italic">
                    De fronte ao Supermercado Ango Delem
                  </p>
                </div>
                <div>
                  <p className="text-slate-400 text-sm mb-1 uppercase tracking-widest font-bold">
                  ...
                  <p className="text-white text-lg">
                    938 460 008 / 942 061 223
                  </p>
                </div>
                <div className="pt-4 border-t border-white/10">
                  <p className="text-orange-500 font-medium italic">
                    &#34;A reforma do mundo começa pela educação.&#34;
                  </p>
                </div>
              </div>
            </motion.div>
